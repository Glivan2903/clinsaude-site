...
// Controla só o inbox de conversas em /admin/whatsapp (lista de conversas,
// chat, envio manual, filtros). Com "false", a página continua existindo,
// mas mostra só a configuração de conexão de cada unidade (QR code/pairing
// code/webhook) — sem histórico de conversa nem envio manual.
export const FEATURE_WHATSAPP_INBOX = isEnabled(process.env.NEXT_PUBLIC_FEATURE_WHATSAPP_INBOX);
