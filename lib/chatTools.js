...
export const toolDefinitions = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Lista o histórico de consultas/exames (agendados, cancelados e realizados) de um paciente a partir do telefone, somando as consultas de todas as unidades da clínica. Use antes de cancelar ou remarcar, para o paciente escolher qual agendamento.',
      parameters: {
        type: 'object',
        properties: {
          telefone: { type: 'string', description: 'Telefone/WhatsApp do paciente, com DDD.' },
