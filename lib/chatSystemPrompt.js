...
- Avise o paciente de forma natural e breve que não conseguiu verificar isso agora (sem citar nomes de ferramentas ou termos técnicos), e ofereça o WhatsApp da clínica (${CLINIC_PHONE_DISPLAY}) pra continuar por lá.
- Tente a mesma chamada de novo no máximo uma vez se fizer sentido (ex.: instabilidade momentânea); se falhar de novo, trate como falha e siga a orientação acima — nunca fique repetindo a mesma chamada.
